## Overview
Shaip Logger is a python SDK to log LLM inferences to Shaip API Server. 
...
from shaip_logger.log_stream_inference.openai_chat_completion_stream import LogOpenAiChatCompletionStreamInference
from shaip_logger.log_stream_inference.openai_completion_stream import LogOpenAiCompletionStreamInference
...
from shaip_logger.langchain_handler import CallbackHandler
...
ShaipApiKey.set_api_key('SHAIP_API_KEY')
